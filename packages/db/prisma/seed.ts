...
async function main() {
  ...
  const articlesData: Array<{
    ...
    // ═══════════════════════════════════════════════════════════
    {
      title: 'Kraken Reportedly in Advanced Talks for Federal Reserve Master Account Access',
      headline: 'Kraken said to be in advanced discussions for Federal Reserve master account — decision pending',
      dek: 'If approved, the San Francisco-based exchange would gain the same level of financial system access as traditional banks, bypassing intermediary banking relationships entirely.',
      summary: 'Kraken is reportedly in advanced discussions for a Federal Reserve master account, which would make it the first cryptocurrency exchange to gain direct access to the US central banking system. Sources familiar with the matter indicate the application is under active review, though no final decision has been announced.',
