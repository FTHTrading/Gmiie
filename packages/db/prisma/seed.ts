...
async function main() {
  ...
  const sourcesData = [
    ...
    { name: 'US Securities and Exchange Commission', url: 'https://sec.gov', feedUrl: 'https://www.sec.gov/cgi-bin/browse-edgar?action=getcurrent&type=&dateb=&owner=include&count=40&search_text=&output=atom', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'North America' },
    { name: 'Federal Reserve', url: 'https://federalreserve.gov', feedUrl: 'https://www.federalreserve.gov/feeds/press_all.xml', sourceType: 'CENTRAL_BANK' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'North America' },
    { name: 'European Central Bank', url: 'https://ecb.europa.eu', feedUrl: 'https://www.ecb.europa.eu/rss/press.html', sourceType: 'CENTRAL_BANK' as const, credibilityTier: 'TIER_1' as const, country: 'EU', region: 'Europe' },
    { name: 'Bank for International Settlements', url: 'https://bis.org', feedUrl: 'https://www.bis.org/doclist/bis_fsi_publs.rss', sourceType: 'CENTRAL_BANK' as const, credibilityTier: 'TIER_1' as const, country: 'CH', region: 'Europe' },
    { name: 'UK Financial Conduct Authority', url: 'https://fca.org.uk', feedUrl: 'https://www.fca.org.uk/news/rss.xml', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'GB', region: 'Europe' },
    { name: 'Bank of England', url: 'https://bankofengland.co.uk', feedUrl: 'https://www.bankofengland.co.uk/rss/news', sourceType: 'CENTRAL_BANK' as const, credibilityTier: 'TIER_1' as const, country: 'GB', region: 'Europe' },
    { name: 'Monetary Authority of Singapore', url: 'https://mas.gov.sg', feedUrl: 'https://www.mas.gov.sg/RSS/News', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'SG', region: 'Asia-Pacific' },
    { name: 'Hong Kong Monetary Authority', url: 'https://hkma.gov.hk', feedUrl: 'https://www.hkma.gov.hk/eng/rss/press-releases.xml', sourceType: 'CENTRAL_BANK' as const, credibilityTier: 'TIER_1' as const, country: 'HK', region: 'Asia-Pacific' },
    { name: 'Bank of Japan', url: 'https://boj.or.jp', feedUrl: 'https://www.boj.or.jp/en/about/release/index.htm/rss.xml', sourceType: 'CENTRAL_BANK' as const, credibilityTier: 'TIER_1' as const, country: 'JP', region: 'Asia-Pacific' },
    { name: 'DTCC', url: 'https://dtcc.com', feedUrl: 'https://www.dtcc.com/rss/press-releases', sourceType: 'INFRASTRUCTURE_PROVIDER' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'North America' },
    { name: 'Euroclear', url: 'https://euroclear.com', feedUrl: 'https://www.euroclear.com/newsandinfo/en/news.RSS.xml', sourceType: 'INFRASTRUCTURE_PROVIDER' as const, credibilityTier: 'TIER_1' as const, country: 'BE', region: 'Europe' },
    { name: 'Clearstream', url: 'https://clearstream.com', feedUrl: 'https://www.clearstream.com/clearstream-en/products-and-services/banking-and-custody/news/rss', sourceType: 'INFRASTRUCTURE_PROVIDER' as const, credibilityTier: 'TIER_1' as const, country: 'LU', region: 'Europe' },
    { name: 'Swiss Financial Market Supervisory Authority', url: 'https://finma.ch', feedUrl: 'https://www.finma.ch/en/rss/', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'CH', region: 'Europe' },
    { name: 'International Monetary Fund', url: 'https://imf.org', feedUrl: 'https://www.imf.org/en/News/rss', sourceType: 'GOVERNMENT' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'Global' },
    { name: 'World Bank', url: 'https://worldbank.org', feedUrl: 'https://feeds.worldbank.org/worldbank/all', sourceType: 'GOVERNMENT' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'Global' },
    { name: 'Financial Stability Board', url: 'https://fsb.org', feedUrl: 'https://www.fsb.org/feed/', sourceType: 'INDUSTRY_BODY' as const, credibilityTier: 'TIER_1' as const, country: 'CH', region: 'Global' },
    { name: 'Abu Dhabi Global Market', url: 'https://adgm.com', feedUrl: 'https://www.adgm.com/news/rss', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'AE', region: 'Middle East' },
    { name: 'Australian Securities and Investments Commission', url: 'https://asic.gov.au', feedUrl: 'https://asic.gov.au/news-centre/rss-feeds/', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'AU', region: 'Asia-Pacific' },
    { name: 'Commodity Futures Trading Commission', url: 'https://cftc.gov', feedUrl: 'https://www.cftc.gov/rss/pressreleases.rss', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'North America' },
    { name: 'Office of the Comptroller of the Currency', url: 'https://occ.gov', feedUrl: 'https://www.occ.gov/news-issuances/rss/occ-news.xml', sourceType: 'REGULATOR' as const, credibilityTier: 'TIER_1' as const, country: 'US', region: 'North America' },
    // TIER_2 — Financial Press (15)
    { name: 'Bloomberg', url: 'https://bloomberg.com', feedUrl: 'https://feeds.bloomberg.com/markets/news.rss', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'US', region: 'Global' },
    { name: 'Financial Times', url: 'https://ft.com', feedUrl: 'https://www.ft.com/rss/home', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Reuters', url: 'https://reuters.com', feedUrl: 'https://feeds.reuters.com/reuters/businessNews', sourceType: 'WIRE_SERVICE' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Wall Street Journal', url: 'https://wsj.com', feedUrl: 'https://feeds.a.dj.com/rss/RSSMarketsMain.xml', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'US', region: 'North America' },
    { name: 'Nikkei Asia', url: 'https://asia.nikkei.com', feedUrl: 'https://asia.nikkei.com/rss/feed/nar', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'JP', region: 'Asia-Pacific' },
    { name: 'The Banker', url: 'https://thebanker.com', feedUrl: 'https://www.thebanker.com/rss', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Risk.net', url: 'https://risk.net', feedUrl: 'https://www.risk.net/rss', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Global Custodian', url: 'https://globalcustodian.com', feedUrl: 'https://www.globalcustodian.com/feed/', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'International Financial Law Review', url: 'https://iflr.com', feedUrl: 'https://www.iflr.com/rss', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Funds Europe', url: 'https://funds-europe.com', feedUrl: 'https://www.funds-europe.com/feed/', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Europe' },
    { name: 'Central Banking', url: 'https://centralbanking.com', feedUrl: 'https://www.centralbanking.com/rss', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Securities Finance Times', url: 'https://securitiesfinancetimes.com', feedUrl: 'https://www.securitiesfinancetimes.com/rss.php', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Asset Servicing Times', url: 'https://assetservicingtimes.com', feedUrl: 'https://www.assetservicingtimes.com/rss.php', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'GB', region: 'Global' },
    { name: 'Ledger Insights', url: 'https://ledgerinsights.com', feedUrl: 'https://www.ledgerinsights.com/feed/', sourceType: 'FINANCIAL_PRESS' as const, credibilityTier: 'TIER_2' as const, country: 'US', region: 'Global' },
    { name: 'The Block', url: 'https://theblock.co', feedUrl: 'https://www.theblock.co/rss.xml', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_2' as const, country: 'US', region: 'Global' },
    ...
    // TIER_3 — Industry (15)
    { name: 'CoinDesk', url: 'https://coindesk.com', feedUrl: 'https://www.coindesk.com/arc/outboundfeeds/rss/', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_3' as const, country: 'US', region: 'Global' },
    { name: 'Cointelegraph', url: 'https://cointelegraph.com', feedUrl: 'https://cointelegraph.com/rss', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_3' as const, country: 'US', region: 'Global' },
    { name: 'DL News', url: 'https://dlnews.com', feedUrl: 'https://www.dlnews.com/arc/outboundfeeds/rss/', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_3' as const, country: 'US', region: 'Global' },
    { name: 'Blockworks', url: 'https://blockworks.co', feedUrl: 'https://blockworks.co/feed', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_3' as const, country: 'US', region: 'Global' },
    { name: 'Unchained', url: 'https://unchainedcrypto.com', feedUrl: 'https://unchainedcrypto.com/feed/', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_3' as const, country: 'US', region: 'Global' },
    { name: 'Decrypt', url: 'https://decrypt.co', feedUrl: 'https://decrypt.co/feed', sourceType: 'CRYPTO_PUBLICATION' as const, credibilityTier: 'TIER_3' as const, country: 'US', region: 'Global' },
  ...
  for (const s of sourcesData) {
    const created = await prisma.source.upsert({
      ...
      create: {
        ...
        slug: slug(s.name),
        url: s.url,
        feedUrl: (s as any).feedUrl ?? null,
        sourceType: s.sourceType,
        credibilityTier: s.credibilityTier,
        country: s.country,
        region: s.region,
        language: (s as any).language ?? 'en',
        isActive: true,
        scrapeMethod: 'RSS',
      },
    });
  ...
  console.log('  Seeding entity-topic relationships...');
  const entityTopicPairs: Array<[string, string]> = [
    // Central Banks
    ['Federal Reserve System', 'Central Bank Digital Currencies'],
    ['Federal Reserve System', 'Stablecoins'],
    ['Federal Reserve System', 'Wholesale CBDC'],
    ['Federal Reserve System', 'Payment Infrastructure'],
    ['European Central Bank', 'Central Bank Digital Currencies'],
    ['European Central Bank', 'Wholesale CBDC'],
    ['European Central Bank', 'Payment Infrastructure'],
    ['Bank of England', 'Central Bank Digital Currencies'],
    ['Bank of England', 'Wholesale CBDC'],
    ['Bank of England', 'Payment Infrastructure'],
    ['Bank of Japan', 'Central Bank Digital Currencies'],
    ['Bank of Japan', 'Wholesale CBDC'],
    ['Peoples Bank of China', 'Central Bank Digital Currencies'],
    ['Peoples Bank of China', 'Programmable Money'],
    ['Swiss National Bank', 'Wholesale CBDC'],
    ['Swiss National Bank', 'Digital Settlement'],
    ['Central Bank of Brazil', 'Central Bank Digital Currencies'],
    ['Central Bank of Brazil', 'Payment Infrastructure'],
    ['Bank for International Settlements', 'Central Bank Digital Currencies'],
    ['Bank for International Settlements', 'Cross-Border Regulation'],
    ['Bank for International Settlements', 'Wholesale CBDC'],
    ['Bank for International Settlements', 'Interoperability'],
    ['Bank for International Settlements', 'Stablecoin Policy'],
    // Regulators
    ['US Securities and Exchange Commission', 'Securities Regulation'],
    ['US Securities and Exchange Commission', 'Tokenized Bonds'],
    ['US Securities and Exchange Commission', 'Tokenized Equities'],
    ['US Securities and Exchange Commission', 'DeFi Regulation'],
    ['US Securities and Exchange Commission', 'Tokenized Funds'],
    ['Commodity Futures Trading Commission', 'Securities Regulation'],
    ['Commodity Futures Trading Commission', 'Stablecoin Policy'],
    ['Commodity Futures Trading Commission', 'DeFi Regulation'],
    ['Financial Conduct Authority', 'Securities Regulation'],
    ['Financial Conduct Authority', 'AML and Compliance'],
    ['Financial Conduct Authority', 'Stablecoin Policy'],
    ['Monetary Authority of Singapore', 'Securities Regulation'],
    ['Monetary Authority of Singapore', 'Tokenized Bonds'],
    ['Monetary Authority of Singapore', 'Tokenized Funds'],
    ['Monetary Authority of Singapore', 'Payment Infrastructure'],
    ['Monetary Authority of Singapore', 'Central Bank Digital Currencies'],
    ['Hong Kong Securities and Futures Commission', 'Securities Regulation'],
    ['Hong Kong Securities and Futures Commission', 'DeFi Regulation'],
    ['European Securities and Markets Authority', 'Securities Regulation'],
    ['European Securities and Markets Authority', 'Stablecoin Policy'],
    ['European Securities and Markets Authority', 'Tokenized Bonds'],
    ['Financial Stability Board', 'Stablecoin Policy'],
    ['Financial Stability Board', 'Cross-Border Regulation'],
    ['Financial Stability Board', 'DeFi Regulation'],
    ['Financial Stability Board', 'AML and Compliance'],
    ['Office of the Comptroller of the Currency', 'Securities Regulation'],
    ['Office of the Comptroller of the Currency', 'Stablecoin Policy'],
    ['Swiss Financial Market Supervisory Authority', 'Securities Regulation'],
    ['Swiss Financial Market Supervisory Authority', 'Tokenized Bonds'],
    // Infrastructure
    ['DTCC', 'Digital Settlement'],
    ['DTCC', 'Clearing and Netting'],
    ['DTCC', 'Tokenized Bonds'],
    ['DTCC', 'Digital Custody'],
    ['DTCC', 'Interoperability'],
    ['Euroclear', 'Digital Settlement'],
    ['Euroclear', 'Digital Custody'],
    ['Euroclear', 'Tokenized Bonds'],
    ['Euroclear', 'Clearing and Netting'],
    ['Clearstream', 'Digital Settlement'],
    ['Clearstream', 'Digital Custody'],
    ['Clearstream', 'Tokenized Bonds'],
    ['SWIFT', 'Payment Infrastructure'],
    ['SWIFT', 'Interoperability'],
    ['SWIFT', 'Cross-Border Regulation'],
    ['Partior', 'Payment Infrastructure'],
    ['Partior', 'Digital Settlement'],
    ['Partior', 'Interoperability'],
    ['Fnality International', 'Wholesale CBDC'],
    ['Fnality International', 'Payment Infrastructure'],
    ['HQLAx', 'Digital Settlement'],
    ['HQLAx', 'Clearing and Netting'],
    ['Broadridge Financial Solutions', 'Digital Settlement'],
    ['Broadridge Financial Solutions', 'Tokenized Bonds'],
    // Banks
    ['JPMorgan Chase', 'Tokenized Bonds'],
    ['JPMorgan Chase', 'Wholesale CBDC'],
    ['JPMorgan Chase', 'Payment Infrastructure'],
    ['JPMorgan Chase', 'Digital Settlement'],
    ['Goldman Sachs', 'Tokenized Bonds'],
    ['Goldman Sachs', 'Digital Settlement'],
    ['Goldman Sachs', 'Exchange Infrastructure'],
    ['UBS', 'Tokenized Bonds'],
    ['Societe Generale', 'Tokenized Bonds'],
    ['Societe Generale', 'DeFi Regulation'],
    ['HSBC', 'Tokenized Bonds'],
    ['HSBC', 'Digital Custody'],
    ['Citigroup', 'Tokenized Bonds'],
    ['Citigroup', 'Payment Infrastructure'],
    ['DBS Bank', 'Tokenized Bonds'],
    ['DBS Bank', 'Exchange Infrastructure'],
    ['DBS Bank', 'Central Bank Digital Currencies'],
    ['BNY Mellon', 'Digital Custody'],
    ['BNY Mellon', 'Tokenized Funds'],
    ['State Street', 'Digital Custody'],
    ['State Street', 'Tokenized Funds'],
    ['Northern Trust', 'Digital Custody'],
    // Exchanges
    ['Nasdaq', 'Exchange Infrastructure'],
    ['Nasdaq', 'Tokenized Equities'],
    ['Nasdaq', 'Digital Custody'],
    ['CME Group', 'Exchange Infrastructure'],
    ['CME Group', 'Clearing and Netting'],
    ['SIX Digital Exchange', 'Exchange Infrastructure'],
    ['SIX Digital Exchange', 'Tokenized Bonds'],
    ['SIX Digital Exchange', 'Digital Settlement'],
    ['Singapore Exchange', 'Exchange Infrastructure'],
    ['Singapore Exchange', 'Tokenized Bonds'],
    ['Coinbase', 'Exchange Infrastructure'],
    ['Coinbase', 'DeFi Regulation'],
    ['Coinbase', 'Digital Custody'],
    ['Kraken', 'Exchange Infrastructure'],
    ['Kraken', 'Stablecoin Policy'],
    ['Binance', 'Exchange Infrastructure'],
    ['Binance', 'Stablecoin Policy'],
    // Asset Managers
    ...
    ['Fidelity Investments', 'Digital Custody'],
    ['Hamilton Lane', 'Tokenized Funds'],
    ['KKR', 'Tokenized Funds'],
    ['Apollo Global Management', 'Tokenized Bonds'],
    // Tokenization & Payment firms
    ['Securitize', 'Tokenized Funds'],
    ['Securitize', 'Tokenized Bonds'],
    ['Securitize', 'Securities Regulation'],
    ['Ondo Finance', 'Tokenized Treasuries'],
    ['Ondo Finance', 'DeFi Regulation'],
    ['Centrifuge', 'Tokenized Bonds'],
    ['Centrifuge', 'DeFi Regulation'],
    ['Fireblocks', 'Digital Custody'],
    ['Fireblocks', 'Interoperability'],
    ['Anchorage Digital', 'Digital Custody'],
    ['Anchorage Digital', 'Securities Regulation'],
    ['Circle', 'Stablecoins'],
    ['Circle', 'Stablecoin Policy'],
    ['Circle', 'Payment Infrastructure'],
    ['Tether', 'Stablecoins'],
    ['Tether', 'Stablecoin Policy'],
    // Protocols
    ['Ethereum Foundation', 'Tokenized Bonds'],
    ['Ethereum Foundation', 'Tokenized Funds'],
    ['Ethereum Foundation', 'DeFi Regulation'],
    ['Ethereum Foundation', 'Programmable Money'],
    ['Ethereum Foundation', 'Interoperability'],
    ['Polygon Labs', 'Tokenized Bonds'],
    ['Polygon Labs', 'DeFi Regulation'],
    ['Polygon Labs', 'Tokenized Funds'],
    ['Avalanche', 'Tokenized Funds'],
    ['Avalanche', 'Interoperability'],
    ['Stellar Development Foundation', 'Payment Infrastructure'],
    ['Stellar Development Foundation', 'Stablecoins'],
    ['Stellar Development Foundation', 'Cross-Border Regulation'],
    ['Canton Network', 'Digital Settlement'],
    ['Canton Network', 'Interoperability'],
    ['Canton Network', 'Tokenized Bonds'],
  ];

  let etPairsCreated = 0;
  for (const [entityName, topicName] of entityTopicPairs) {
    const entityId = entities[entityName];
    const topicId = topics[topicName];
    if (!entityId || !topicId) continue;
  ...
  console.log(`  ✓ ${etPairsCreated} entity-topic relationships seeded`);
